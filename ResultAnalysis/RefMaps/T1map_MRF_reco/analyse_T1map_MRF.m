...
%% Chargement d'une carte de B1rel de même géométrie
...
for kx=1:Nx
    for ky=1:Ny
        if Images_dicom_rescaled(kx,ky,1)>0  % Pour les voxels  périphériques de signal nul, on pose T1=0ms
            global B1
            B1=B1relMap(kx,ky);
