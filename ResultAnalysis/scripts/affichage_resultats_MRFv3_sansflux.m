...
subplot(2,3,1)
imagesc(Properties.T1list(Reconstruction.t_exp_dicom))
caxis([0 3000])
colorbar
...
subplot(2,3,2)
imagesc(Properties.T2list(Reconstruction.t_exp_dicom))
caxis([0 300])
colorbar
...
subplot(2,3,4)
imagesc(abs(Properties.dflist(Reconstruction.t_exp_dicom)))
caxis([0 50])
colorbar
...
subplot(2,3,3)
imagesc(Properties.B1rellist(Reconstruction.t_exp_dicom))
caxis([0.6 1.2])
colorbar
